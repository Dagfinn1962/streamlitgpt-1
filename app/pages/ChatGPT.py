...
with st.sidebar:
    ...
    temperature = st.slider(
        label="Temperature", min_value=0.0, max_value=2.0, value=0.8
    )
    ...
    frequency_penalty = st.slider(
        label="Frequency Penalty", min_value=-2.0, max_value=2.0, value=0.5
    )
    ...
    presence_penalty = st.slider(
        label="Presence Penalty", min_value=-2.0, max_value=2.0, value=0.0
    )
